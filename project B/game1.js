...
function setup() {
    ...
    notes.push(new Note(270.5, 436, 98, 205, 255));
    notes.push(new Note(409.5, 479, 98, 205, 255));
    notes.push(new Note(143.5, 394, 98, 205, 255));
    notes.push(new Note(211.5, 645, 98, 205, 255));
    notes.push(new Note(343.5, 685, 98, 205, 255));
    stations.push(new Station(137.5, 267, 98, 205, 255));
    stations.push(new Station(266.5, 266, 98, 205, 255));
    stations.push(new Station(404.5, 267, 98, 205, 255));
    drums.push(new Drum(115.5, 537, 98, 205, 255));
    drums.push(new Drum(115.5, 823, 98, 205, 255));
}

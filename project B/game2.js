...
function setup() {
    ...
    notes.push(new Note(73, 489, 98, 205, 255));
    notes.push(new Note(303, 454, 98, 205, 255));
    notes.push(new Note(387, 417, 98, 205, 255));
    stations.push(new Station(174, 301, 98, 205, 255));
    stations.push(new Station(204, 204, 98, 205, 255));
    drums.push(new Drum(190, 406, 98, 205, 255));
    drums.push(new Drum(361, 659, 98, 205, 255));
}

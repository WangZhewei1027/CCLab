...
function setup() {
    ...
    notes.push(new Note(380.5, 519, 98, 205, 255));
    notes.push(new Note(163.5, 577, 98, 205, 255));
    notes.push(new Note(59.5, 379, 98, 205, 255));
    stations.push(new Station(225.5, 203, 98, 205, 255));
    stations.push(new Station(244.5, 176, 98, 205, 255));
    stations.push(new Station(263.5, 148, 98, 205, 255));
    drums.push(new Drum(252.5, 355, 98, 205, 255));
    drums.push(new Drum(361.5, 703, 98, 205, 255));
}
